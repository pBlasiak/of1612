...
superFluidWallUnFvPatchVectorField
(
    const superFluidWallUnFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
superFluidWallUnFvPatchVectorField
(
    const superFluidWallUnFvPatchVectorField& sfwpvf
)
:
...
void Foam::superFluidWallUnFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    vectorField::operator=(-rhosWall/rhoWall*Bwall*GwallNorm);

    fixedValueFvPatchVectorField::updateCoeffs();
}


void Foam::superFluidWallUnFvPatchVectorField::write(Ostream& os) const
{
